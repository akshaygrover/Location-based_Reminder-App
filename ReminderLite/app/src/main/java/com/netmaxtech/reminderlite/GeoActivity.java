...
import com.netmaxtech.reminderlite.ui.ShowList;
...
public class GeoActivity extends ActionBarActivity implements
    ...
    private HashMap<String, LatLng> myReminders = new HashMap<String, LatLng>();
    ...
    private ImageButton addGeoF;
    private ImageButton remGeoF;

    private ImageButton b3,b4;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Get the UI widgets.
        addGeoF = (ImageButton) findViewById(R.id.add_geofences_button);
        remGeoF = (ImageButton) findViewById(R.id.remove_geofences_button);
        b3 = (ImageButton)findViewById(R.id.viewgeo);
        b4 = (ImageButton)findViewById(R.id.viewalarm);


        addGeoF.setOnClickListener(this);
        remGeoF.setOnClickListener(this);
    ...
    {
        Intent in = new Intent(this, ShowLocationsReminder.class);
        startActivity(in);
    }
    public void viewRem(View v)
    {
        Intent in=new Intent(this,ShowList.class);
        startActivity(in);
    ...
    private void setButtonsEnabledState() {
        if (mGeofencesAdded) {
            addGeoF.setEnabled(false);
            remGeoF.setEnabled(true);
        } else {
            addGeoF.setEnabled(true);
            remGeoF.setEnabled(false);
        }
    }
    ...
    private void populateGeoFData()
    {
        ...
        DataHelper dh1 = new DataHelper(this);
